...
def timed_job():
    ...
    driver = webdriver.Firefox(executable_path='/app/geckodriver', capabilities=capabilities, firefox_binary=binary, firefox_profile=profile, log_path='/app/.heroku/python/geckodriver.log')
